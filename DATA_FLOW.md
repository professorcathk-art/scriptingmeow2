...
**Output:** brand_personality, tone_of_voice, visual_style (colors, colorDescriptionDetailed, imageStyle, lineStyle, typographySpec, imageGenerationPrompt, …), dos_and_donts
...
**Prompt uses:** colorDescriptionDetailed, lineStyle, typographySpec, imageGenerationPrompt from brandbook.
